    ...
    "results": [
      {
        ...
        "urls": [
          {
            "type": "detail",
            "url": "http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=69211c73c3a60275173aea75eb4ae8a8"
          },
          {
            "type": "comiclink",
            "url": "http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=69211c73c3a60275173aea75eb4ae8a8"
          }
        ]
      }
    ]
...
object ObjectsByJson {
    fun getCharacters(): DataWrapper<CharacterDto> {
        val nameClass = object : TypeToken<DataWrapper<CharacterDto>>() {}.type
        return Gson().fromJson(charactersJson, nameClass )
    }
}